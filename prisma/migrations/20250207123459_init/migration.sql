...
CREATE TABLE "Product" (
    ...
    "title" TEXT NOT NULL,
    "slug" TEXT NOT NULL,
    "priceInEuroCents" INTEGER NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "Order_productStockId_key" ON "Order"("productStockId");
...
-- AddForeignKey
ALTER TABLE "Order" ADD CONSTRAINT "Order_productStockId_fkey" FOREIGN KEY ("productStockId") REFERENCES "ProductStock"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
